...
public class MCreatorMPhones extends mphones.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("mphones:mphones", "inventory"));
	}
	...
	public static class ItemCustom extends Item {
		...
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("mphones");
			setRegistryName("mphones");
